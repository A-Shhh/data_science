...
- [Online Store: Увеличение продаж](#online-store-увеличение-продаж)
- [HR Analytics: Удержание сотрудников](#hr-analytics-удержание-сотрудников)
- [Выбор скважины для добычи нефти](#выбор-скважины-для-добычи-нефти)
...
> Анализ кредитных данных: определение рисков невозврата займов и разработка модели прогнозирования.
...
> Исследование объявлений о продаже квартир: выявление аномалий, оценка рыночной стоимости, поиск ключевых факторов.
...
**Файлы**:
- 📄 [Jupyter Notebook (IPYNB)](https://github.com/ASh-Archives/data_science/blob/main/ipynb_view/03_research_apartments.ipynb)
- 🌐 [HTML-версия](https://html-preview.github.io/?url=https://github.com/ASh-Archives/data_science/blob/main/html_view/03_research_apartments.html)
...
## 💼 HR Analytics: Удержание сотрудников
...
## ⛏️ Выбор скважины для добычи нефти
...
## 📡 Telecom Company: Удержание клиентов

> Анализ данных телеком-компании: прогноз оттока клиентов и разработка стратегии удержания.
